...
class SimpleNovaSonic:
    ...
    async def start_session(self):
        ...
        system_prompt = f"You are a CelcomDigi Call Center Bot. The user and you will engage in a spoken dialog exchanging the transcripts of a natural real-time conversation. Be helpful"
